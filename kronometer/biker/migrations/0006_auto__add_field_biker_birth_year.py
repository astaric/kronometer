...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Biker.birth_year'
        db.add_column('biker_biker', 'birth_year',
                      self.gf('django.db.models.fields.IntegerField')(blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Biker.birth_year'
        db.delete_column('biker_biker', 'birth_year')


    models = {
        'biker.biker': {
            'Meta': {'object_name': 'Biker'},
            'birth_year': ('django.db.models.fields.IntegerField', [], {'blank': 'True', 'null': 'True'}),
